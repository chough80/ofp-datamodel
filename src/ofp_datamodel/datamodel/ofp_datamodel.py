...
class NamedThing(YAMLRoot):
    ...
    class_model_uri: ClassVar[URIRef] = OFP_DATAMODEL.NamedThing
...
class Person(NamedThing):
    ...
    class_class_uri: ClassVar[URIRef] = OFP_DATAMODEL["Person"]
    class_class_curie: ClassVar[str] = "ofp_datamodel:Person"
    class_name: ClassVar[str] = "Person"
    class_model_uri: ClassVar[URIRef] = OFP_DATAMODEL.Person
...
class PersonCollection(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = OFP_DATAMODEL["PersonCollection"]
    class_class_curie: ClassVar[str] = "ofp_datamodel:PersonCollection"
    class_name: ClassVar[str] = "PersonCollection"
    class_model_uri: ClassVar[URIRef] = OFP_DATAMODEL.PersonCollection
...
slots.id = Slot(uri=SCHEMA.identifier, name="id", curie=SCHEMA.curie('identifier'),
                   model_uri=OFP_DATAMODEL.id, domain=None, range=URIRef)

slots.name = Slot(uri=SCHEMA.name, name="name", curie=SCHEMA.curie('name'),
                   model_uri=OFP_DATAMODEL.name, domain=None, range=Optional[str])

slots.description = Slot(uri=SCHEMA.description, name="description", curie=SCHEMA.curie('description'),
                   model_uri=OFP_DATAMODEL.description, domain=None, range=Optional[str])

slots.primary_email = Slot(uri=SCHEMA.email, name="primary_email", curie=SCHEMA.curie('email'),
                   model_uri=OFP_DATAMODEL.primary_email, domain=None, range=Optional[str])

slots.birth_date = Slot(uri=SCHEMA.birthDate, name="birth_date", curie=SCHEMA.curie('birthDate'),
                   model_uri=OFP_DATAMODEL.birth_date, domain=None, range=Optional[Union[str, XSDDate]])

slots.age_in_years = Slot(uri=OFP_DATAMODEL.age_in_years, name="age_in_years", curie=OFP_DATAMODEL.curie('age_in_years'),
                   model_uri=OFP_DATAMODEL.age_in_years, domain=None, range=Optional[int])
